...
//hide the low signal strengthes 
#define CONFIG_HIDE_PROXIMITY_SIGNAL_STRENGTH
...
#ifdef CONFIG_HIDE_PROXIMITY_SIGNAL_STRENGTH
//start powerlevel is 4 when HIRES_LOCATION and
//HIDE_PROXIMITY_SIGNAL_STRENGTH is defined
#define CONFIG_MIN_POWER_LEVEL 4
#else
//start powerlevel is 0 when HIRES_LOCATION and
//HIDE_PROXIMITY_SIGNAL_STRENGTH not defined
#define CONFIG_MIN_POWER_LEVEL 0;
#endif CONFIG_HIDE_PROXIMITY_SIGNAL_STRENGTH
